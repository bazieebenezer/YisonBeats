    ...
    <div className="pb-20">
      <section className="container py-16 md:py-24">
        <div className="space-y-5 text-center max-w-3xl mx-auto">
          <p className="text-xs font-medium uppercase tracking-[0.3em] text-muted-foreground">Notre histoire</p>
      ...
      <section className="container py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-lg border border-border bg-muted/40 px-3 py-1.5 text-xs font-medium text-muted-foreground uppercase tracking-widest">
              <Music className="h-4 w-4" aria-hidden="true" /> Mon histoire
            </div>
            <h2 className="text-4xl md:text-5xl font-extrabold leading-tight">
              La Musique Est Mon <span className="underline decoration-foreground/30 decoration-4 underline-offset-8">Langage</span>
            </h2>
      ...
      <section className="container py-20 border-t border-border/60">
        <div className="text-center space-y-4 mb-16">
          <p className="text-xs font-bold uppercase tracking-[0.3em] text-primary">Nos valeurs</p>
          <h2 className="text-3xl md:text-4xl font-extrabold">Pourquoi Choisir YisonBeats ?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            return (
              <div key={item.title} className="p-8 rounded-xl border border-border/60 bg-card space-y-4  transition-shadow">
      ...
      <section className="container px-4">
        <div className="relative rounded-xl border border-border bg-muted/30 px-8 py-16 text-center">
