...
export default function AccountDashboard() {
  const stats = [
    { name: "Commandes", value: "3", icon: ShoppingBag, color: "text-blue-500", bg: "bg-blue-50" },
    { name: "Téléchargements", value: "8", icon: Download, color: "text-green-500", bg: "bg-green-50" },
    { name: "Favoris", value: "12", icon: Heart, color: "text-red-500", bg: "bg-red-50" },
