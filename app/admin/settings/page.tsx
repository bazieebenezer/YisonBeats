        ...
        <CardContent className="p-8 space-y-8">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ml-14">
              <div className="space-y-2">
                ...
                <input id="nom-boutique" type="text" className="h-11 w-full rounded-lg border border-border bg-muted/50 px-4 transition-colors focus:border-primary/50 focus:ring-2 focus:ring-primary/20 placeholder:text-muted-foreground" defaultValue="YIsonBits" />
              </div>
              <div className="space-y-2">
                ...
                <input id="email-contact" type="email" className="h-11 w-full rounded-lg border border-border bg-muted/50 px-4 transition-colors focus:border-primary/50 focus:ring-2 focus:ring-primary/20 placeholder:text-muted-foreground" defaultValue="contact@yisonbits.com" />
              </div>
              <div className="space-y-2 md:col-span-2">
                ...
                <textarea id="description-courte" rows={3} className="w-full rounded-xl border border-border bg-muted/50 px-4 py-3 transition-colors focus:border-primary/50 focus:ring-2 focus:ring-primary/20 placeholder:text-muted-foreground" defaultValue="Boutique de beats, loops, samples et services musicaux par YIsonBits." />
              </div>
            </div>
          </div>
          ...
          <div className="border-t pt-8 space-y-6">
            ...
            <div className="space-y-4 ml-14">
              {[
                { Icon: Wallet, name: "Wave", info: "Numéro Wave : +226 00 00 00 00", color: "bg-blue-600 text-white" },
                { Icon: Smartphone, name: "Orange Money", info: "Numéro Orange Money : +226 00 00 00 00", color: "bg-orange-500 text-white" },
                { Icon: Smartphone, name: "MTN MoMo", info: "Numéro MTN MoMo : +226 00 00 00 00", color: "bg-yellow-400 text-yellow-950" },
                { Icon: CreditCard, name: "Carte bancaire", info: "CinetPay / Paystack (Visa, Mastercard)", color: "bg-violet-600 text-white" },
              ].map((m) => (
                <div key={m.name} className="p-4 rounded-xl border bg-primary/5 border-primary/20 flex items-start gap-3">
                  <div className={`h-9 w-9 rounded-xl ${m.color} flex items-center justify-center shrink-0`}>
